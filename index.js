...
<body><div class="page">
  ...
  <div class="card">
    ...
    <p style="color:#adadb8;font-size:13px;margin:0 0 8px">Добавь этот URL как Browser Source (размер: 1600×210, прозрачный фон):</p>
...
<script>
  ...
  const T_IN=650,T_STAND=6000,T_ROLL=3500,T_AFTER_RESULT=5500,T_OUT=650;
